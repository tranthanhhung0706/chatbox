...
async function handlePostback(sender_psid, received_postback){
    ...
    switch(payload) {
        ...
        case 'GET_STARTED':
            // code block
            response1= homepageService.handleGetStartedButton();
            username=await getUserName(sender_psid);
            response={"text":` Xin chao User name ${username}` };
            callSendAPI(sender_psid, response);
        ...
        case 'RESTART_CONVERSATION':
            ...
            break;
        case 'MAIN_MENU':
            response=homepageService.handleSendMainMenu();
            callSendAPI(sender_psid, response);
            break;
        default:
            response = { "text": "I dont know postback !." }
          // code block
    }
